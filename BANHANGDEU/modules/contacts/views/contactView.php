        ...
        <div class="section" id="order-review-wp">
            ...
            <div class="section-detail">
                <table class="shop-table">
                    ...
                    <tbody>
                        <tr class="cart-item">
                            <td class="product-name">Chí Linh - Hải Dương <strong class="product-quantity"></strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Mobile: +84123456789<strong class="product-quantity"></strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Fax: 1-714-252-0026<strong class="product-quantity"></strong></td>
                        </tr>
                        <tr class="order-total">
                            <td><strong class="total-price">lequangkhai134@gmail.com</strong></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr class="order-total">
                        		...
                        		<strong class="total-price">
                        			<ul>
										<li style="display: inline-block; padding: 0px 20px; font-size: 50px;">
											<a style="color:gray;" href="https://www.facebook.com/profile.php?id=100012521899379"><i class="fa fa-facebook"></i></a>
										</li >
										<li style="display: inline-block;padding: 0px 20px;font-size: 50px;">
