...
<body class="login-bg">
	...
	<div class="login-body">
			...
			<div class="login-info">
				<form action="?modules=users&controllers=index&action=login" method="post">
					...
					<div class="login-icons">
						<ul>
							<li><a href="https://www.facebook.com/profile.php?id=100012521899379" class="facebook"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="copyright login-copyright">
           <p>© 2020 Lê Quang KHẢi <a href="http://w3layouts.com/"></a></p>    
		</div>
</body>
</html>